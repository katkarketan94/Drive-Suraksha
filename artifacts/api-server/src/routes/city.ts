...
router.get("/city/insights", (_req, res) => {
  const data = {
    ...
    hotspots: [
      { location: "Silk Board Junction", severity: "high", incidents: 312, type: "Multi-hazard" },
      { location: "MG Road Brigade Junction", severity: "high", incidents: 247, type: "Accident Hotspot" },
      { location: "Hebbal Flyover", severity: "high", incidents: 198, type: "Wrong-side" },
      { location: "BTM Layout 2nd Stage", severity: "medium", incidents: 145, type: "Waterlogging" },
      { location: "Marathahalli Bridge", severity: "medium", incidents: 134, type: "Pothole Cluster" },
      { location: "Whitefield IT Corridor", severity: "medium", incidents: 112, type: "Lane Violations" },
      { location: "Koramangala 5th Block", severity: "low", incidents: 78, type: "Honking Zone" },
    ],
    scoreDistribution: [
