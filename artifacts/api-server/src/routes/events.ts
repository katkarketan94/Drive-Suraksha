...
const seedEvents: DrivingEvent[] = [
  {
    ...
    description: "Large pothole cluster detected on the Eastern Express Highway approach near Sion overbridge.",
    scoreImpact: -15,
  ...
  },
  {
    ...
    type: "honking_spike",
    severity: "medium",
    location: "SV Road, Mumbai",
    description: "Excessive honking detected in the 500m stretch near Linking Road junction, Bandra.",
    scoreImpact: -5,
  ...
  },
  {
    ...
    description: "Vehicle crossed the centre divider into oncoming lane near Bandra police station.",
    scoreImpact: -10,
  ...
  },
  {
    ...
    description: "Consistent speed maintained, no violations detected in a 2km stretch on JVLR.",
    scoreImpact: 3,
  ...
  },
  {
    ...
    description: "Pedestrian detected crossing without signal at Hiranandani entrance. Vehicle braking required.",
    scoreImpact: -7,
